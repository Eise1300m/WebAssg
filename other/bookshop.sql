...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2025 at 12:43 PM
...
(1, 'Funny Story', 22.00, 'Funny Story is a romance novel that follows librarian Daphne and Miles, whose exes are dating each other. As they navigate their intertwined lives, they discover unexpected connections and humor in their shared circumstances.', 'Emily Henry', '../upload/bookPfp/Funny Story.png', 101),
...
(14, 'The Locked Door', 28.99, 'While eleven-year-old Nora Davis was up in her bedroom doing homework, she had no idea her father was killing women in the basement.', 'Freida McFadden', '../upload/bookPfp/The Locked Door.png', 102),
...
(23, 'Ambessa', 29.99, 'Ambessa Medarda: Warrior, general, mother.', 'C.L.Clark', '../upload/bookPfp/Ambessa.png', 103),
(24, 'Why on Earth: An Alien Invasion Anthology', 24.99, '', 'Vania Stoyanova', '../upload/bookPfp/Why on Earth - An Alien Invasion Anthology.png', 103),
...
(107, 'A Galaxy Next Door', 19.99, 'After high school, Kuga Ichirou started his career as a manga artist.', 'Gido Amagakure', '../upload/bookPfp/A Galaxy Next Door.png', 201),
...
(115, 'Wytches, Volume 1', 19.99, 'Everything you thought you knew about witches is wrong.', 'Scott Snyder', '../upload/bookPfp/Wytches, Volume 1.png', 202),
...
(129, 'House of M', 19.99, 'The Avengers and the X-Men are faced with a common foe that becomes their greatest threat: Wanda Maximoff!', 'Brian Michael Bendis', '../upload/bookPfp/House of M.png', 203),
...
(144, 'Gyo', 29.99, 'The floating smell of death hangs over the island.', 'Junji Ito', '../upload/bookPfp/Gyo.png', 205),
...
(148, 'Jane Austen: An Illustrated Biography', 39.99, 'Beautifully illustrated and full of interesting facts, this book tells the story of who Jane Austen was from her birth right through to the end.', 'Zena Alkayat', '../upload/bookPfp/Jane Austen - An Illustrated Biography.png', 205),
...
(203, 'Goodnight Moon', 29.99, 'In a great green room, tucked away in bed, is a little bunny.', 'Margaret Wise Brown', '../upload/bookPfp/Goodnight Moon.png', 301),
...
(209, 'Are You My Mother?', 19.99, 'Tells a very simple story for children who have just started to read.', 'P.D.Eastman', '../upload/bookPfp/Are You My Mother.png', 301),
...
(216, 'The Snow Queen', 12.99, 'The Snow Queen is a story about the strength and endurance of childhood friendship.', 'Hans Christian Andersen', '../upload/bookPfp/The Snow Queen.png', 302),
...
(218, 'The Reluctant Dragon', 22.99, 'In this beloved classic story, a young boy befriends a poetry-loving dragon living in the Downs above his home.', 'Kenneth Grahame', '../upload/bookPfp/The Reluctant Dragon.png', 302),
...
(233, 'A Day in the Life of a Muslim Child', 32.99, 'This beautiful book describes a day in the life of a Muslim Child.', 'Abdul Malik Mujahid', '../upload/bookPfp/A Day in the Life of a Muslim Child.png', 304),
...
(241, 'The Tale of Peter Rabbit', 29.99, 'Follow the story of naughty Peter Rabbit as he squeezes—predictably—under the gate into Mr. McGregor\'s garden and finds himself in all kinds of trouble!', 'Beatrix Potter', '../upload/bookPfp/The Tale of Peter Rabbit.png', 305),
...
(246, 'The Call of the Wild', 32.99, 'Is a tale about unbreakable spirit and the fight for survival in the frozen Alaskan Klondike.', 'Jack London', '../upload/bookPfp/The Call of the Wild.png', 305),
(247, 'Old Yeller', 39.99, 'Old Yeller is a coming of age story about a boy named Travis and his family living in Salt Lick, Texas in the 1860s.', 'Fred Gipson', '../upload/bookPfp/Old Yeller.png', 305),
...
(249, 'Sunshine\'s Excellent Adventures', 19.99, 'This little book is about a wonderful cat, who shared his life with his devoted adopted parents, Reggie and Anita.', 'Reggie Hill', '../upload/bookPfp/Sunshine\'s Excellent Adventures.png', 305),
...
(308, 'Learn Like a Pro', 29.99, 'A book for learners of all ages containing the best and most updated advice on learning from neuroscience and cognitive psychology.', 'Barbara Oakley', '../upload/bookPfp/Learn Like a Pro.png', 402),
...
(314, 'Perfect Victims: And the Politics of Appeal', 49.99, 'Masterfully combining candid testimony, history, and reportage, Perfect Victims presents a powerfully simple dignity for the Palestinian.', 'Mohammed El-Kurd', '../upload/bookPfp/Perfect Victims - And the Politics of Appeal.png', 403),
...
(320, 'Word by Word: The Secret Life of Dictionaries', 42.99, 'A sure delight for all lovers of words, Word by Word might also quietly improve readers grasp and use of the English language.', 'Kory Stamper', '../upload/bookPfp/Word by Word - The Secret Life of Dictionaries.png', 404),
...
(1, '2025-03-28 13:10:01', 1, 13.79, 'debit card', 14, 5, 'Complete');
...
(1, 'Jiajia', '$2y$10$IXAOe7GNNWPz8nJfnGGHoOhBuH2G5ngaZK6fuVlHIe9Y8E2aTvRMG', 'adasd@gmail.com', '0123455465', 'customer', '../upload/customerPfp/1_1742969603.png'),
(2, 'Admin01', '$2y$10$tXaYNPCzpi.3AkeO./jRfeYspgWj8sZLJ11UZHU7PSRkSPFVWhLly', 'AhMan@gmail.com', '0120111285', 'admin', '../upload/adminPfp/2_1743167524.jpg'),
...
(11, 'Aimi', '$2y$10$IyJJuKlVfuITsvBBoP1RtuuKjYXmewAQ0Mi6d7iBcT6zKuWO5RAo.', 'Aimi@gmail.com', '0128974581', 'customer', '../upload/icon/UnknownUser.jpg'),
...
--
ALTER TABLE `book`
  MODIFY `BookNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=342;
