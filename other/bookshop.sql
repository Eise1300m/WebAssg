...
(51, 'Lore Olympus', 20.99, 'An ingenious take on the Greek Pantheon, Lore Olympus is a modern update on the story of Hades and Persephone. Follow the propulsive love story of two Greek gods, told with lavish artwork and contemporary sensibilities.', 'Rachel Smythe', '../upload/bookPfp/Lore Olympus.png', 201),
(52, 'Lunar New Year Love Story', 21.99, 'Val is ready to give up on love. It\'s led to nothing but secrets and heartbreak, and she\'s pretty sure she\'s cursed—no one in her family, for generations, has ever had any luck with love. But then a chance encounter with a pair of cute lion dancers sparks something in Val. Is it real love?', 'Gene Luen Yang', '../upload/bookPfp/Lunar New Year Love Story.png', 201),
(53, 'Fangs', 58.50, 'Elsie the vampire is three hundred years old, but in all that time, she has never met her match. This all changes one night in a bar when she meets Jimmy, a charming werewolf with a wry sense of humor and a fondness for running wild during the full moon.', 'Sarah Anderson', '../upload/bookPfp/Fangs.png', 201),
(54, 'Be Kind, My Neighbor', 40.99, 'Be Kind, My Neighbor is set in 1973 in the small American town of Baths. Here Mr. Neighbor, an endearingly friendly rag doll, forms a friendship with Wegg, a travelling busker, after the latter is the victim of a street assault.', 'Yugo Limbo', '../upload/bookPfp/Be Kind, My Neighbor.png', 201),
(55, 'Jaehon Hwangho', 22.99, 'Navier, the perfect empress of the Eastern Empire. When she finds out that her husband, the emperor, is trying to make his wife the empress, she decides to divorce. And she decides. If she can\'t be the empress here, she\'ll be the empress somewhere else.', 'Alphatart', '../upload/bookPfp/Jaehon Hwangho.png', 201),
...
(66, 'The Crow', 22.50, 'The night before his wedding, musician Eric Draven and his fiancée are brutally murdered by members of a violent gang. On the anniversary of their death, Eric rises from the grave and assumes the mantle of the Crow, a supernatural avenger.', 'James O\'Barr', '../upload/bookPfp/The Crow.png', 202),
(67, 'Tomie', 52.99, 'Tomie is a malevolent, regenerative entity with the unexplained ability to cause anyone, particularly men, to be instantly attracted to her. These actions inevitably lead to violence, usually resulting in the murder of Tomie herself (allowing her to replicate herself), or others.', 'Junji Ito', '../upload/bookPfp/Tomie.png', 202),
...
(69, 'Panorama of Hell', 74.50, 'An artist describes his work, consisting of hellish views he paints using his own blood. He then introduces the reader to his unconventional family, and tells stories about his abusive parents, who escaped from Manchuria after World War II, and his violent childhood.', 'Hideshi Hino', '../upload/bookPfp/Panorama of Hell.png', 202),
(70, 'Severed', 58.99, 'Severed follows the story of Jack Garron, a 12-year old who runs away from home in order to find his father when he discovers the truth about his own identity. What Garron discovers, however, is that as exciting as life on the road can be, it can also be a place of hardship, heartbreak, and, indeed, terror.', 'Scott Snyder', '../upload/bookPfp/Severed.png', 202),
(71, 'Watchmen', 60.99, 'Watchmen depicts an alternate history in which superheroes emerged in the 1940s and 1960s and their presence changed history so that the United States won the Vietnam War and the Watergate scandal was never exposed.', 'Alan Moore', '../upload/bookPfp/Watchmen.png', 203),
(72, 'Batman: The Dark Knight Returns', 84.99, 'The Dark Knight Returns is a Batman story written by Frank Miller with illustrations by Miller, Klaus Janson, and Lynn Varley in 1986. It is a limited series set in a possible future, portrayed as Batman\'s last adventure. The story depicts Bruce Wayne as an old man, coming out of retirement to be Batman again.', 'Frank Miller', '../upload/bookPfp/Batman - The Dark Knight Returns.png', 203),
(73, 'Kingdom Come', 42.99, 'In a future where metahumans run rampant and are a menace to society, Superman, Wonder Woman, Batman, and other traditional superheroes attempt to contain the escalating disaster and prevent a metahuman war.', 'Mark Waid', '../upload/bookPfp/Kingdom Come.png', 203),
...
(77, 'Marvel 1602', 77.99, 'The eight-part series takes place in a timeline where Marvel superheroes exist in the Elizabethan era; faced with the destruction of their world by a mysterious force, the heroes must fight to save their universe.', 'Neil Gaiman', '../upload/bookPfp/Marvel 1602.png', 203),
(78, 'All-Star Superman, Vol.1', 112.99, 'Superman\'s arch nemesis Lex Luthor has finally devised a way to kill the Man of Steel, and so far it seems as if Luthor may have finally succeeded. During all this, Superman reveals his identity to Lois Lane as well before taking flight against Luthor and ultimately saving the day.', 'Grant Morrison', '../upload/bookPfp/All-Star Superman, Vol.1.png', 203),
(79, 'House of M', 29.99, 'House of M is a story of grief, grandeur, and god-like powers. It is one of the most iconic Marvel story arcs, roping in the X-Men, the Avengers, and every other group of heroes across Marvel Comics.', 'Brian Michael Bendis', '../upload/bookPfp/House of M.png', 203),
(80, 'Superman for All Seasons', 100.00, 'This book takes a look at the life of a young Clark Kent as he begins to develop strange powers. Living in a small Kansas town, the boy who would grow to be the Man of Steel must come to terms with his true origin and his uncanny abilities.', 'Jeph Loeb', '../upload/bookPfp/Superman for All Seasons.png', 203),
(81, 'The Spellman Files', 32.00, 'A spirited, funny debut from screenwriter Lutz that mixes chick-lit, mystery and a dose of TV nostalgia. Isabel Spellman has family issues. Her parents are a mismatched pair of private investigators who routinely run credit and background checks on their older daughter\'s dates.', 'Lisa Lutz', '../upload/bookPfp/The Spellman Files.png', 204),
(82, 'Coyote Doggirl', 62.99, 'Coyote is a dreamer and a drama queen, brazen and brave, faithful yet fiercely independent. She beats her own drum and sews her own crop tops. A gifted equestrian, she\'s half dog, half coyote, and all power.', 'Lisa Hanawalt', '../upload/bookPfp/Coyote Doggirl.png', 204),
(83, 'French Exit', 14.99, 'Set in New York City and Paris, the novel follows a dysfunctional mother and son duo who are forced to relocate after their fortunes fall. The title French Exit refers to the expression also known as french leave of an abrupt or hasty departure made without informing anyone.', 'Patrick deWitt', '../upload/bookPfp/French Exit.png', 204),
(84, 'Savage Season', 48.00, 'Tricia Stevens, a young and beautiful woman, has a normal life. Suddenly, she finds herself in a world where there is no sense. Tricia Stevens, a young and beautiful woman, has a normal life.', 'Joe R.Lansdale', '../upload/bookPfp/Savage Season.png', 204),
(85, 'Dad Is Fat', 75.00, '\"Dad Is Fat\" describes a comedian and author\'s humorous perspective on the common experience of men, often in their \"dad era,\" carrying a bit of extra weight, particularly around the midsection. The term \"Dad Bod,\" popularized by comedian Jim Gaffigan, refers to men in their late 20s to 50s who have a more relaxed physique with a tendency to be slightly overweight. ', 'Jim Gaffigan', '../upload/bookPfp/Dad Is Fat.png', 204),
(86, 'Breakfast of Champions', 38.99, 'Breakfast of Champions follows misanthropic sci-fi author Kilgore Trout, whose stories tend to be published in, er, adult magazines. One day, Dwayne Hoover, a car dealer who is losing his mind, will take Trout\'s fiction seriously and do something terrible, and it will alter the course of Trout\'s life.', 'Kurt Vonnegut Jr', '../upload/bookPfp/Breakfast of Champions.png', 204),
(87, 'Calvin and Hobbes', 26.99, 'The strip follows six-year-old Calvin and his best friend, a tiger named Hobbes. Calvin and Hobbes draws heavily upon Watterson\'s experiences growing up in CHAGRIN FALLS, a neighborhood of Cleveland, Ohio.', 'Bill Watterson', '../upload/bookPfp/Calvin and Hobbes.png', 204),
(88, 'Food: A Love Story', 22.99, 'Bacon, McDonalds, Cinnabon, Hot Pockets, Kale. Stand-up comedian and author Jim Gaffigan has made his career rhapsodizing over the most treasured dishes of the American diet (“choking on bacon is like getting murdered by your lover”) and decrying the worst offenders (“kale is the early morning of foods”).', 'Jim Gaffigan', '../upload/bookPfp/Food - A Love Story.png', 204),
(89, 'Undermajordomo Minor', 40.00, 'Undermajordomo Minor is an ink-black comedy of manners, an adventure, and a mystery, and a searing portrayal of rural Alpine bad behaviour, but above all it is a love story. And Lucy must be careful, for love is a violent thing.', 'Patrick deWitt', '../upload/bookPfp/Undermajordomo Minor.png', 204),
(90, 'T-Rex Trying', 24.99, 'Though the T-Rex may struggle, you\'ll never struggle with finding dinosaur gifts again! This hilarious and perfectly giftable book is perfect for anyone who has ever wondered how a T-Rex could get anything done with such tiny arms.', 'Hugh Murphy', '../upload/bookPfp/T-Rex Trying.png', 204),
(91, 'Velvet', 42.50, 'A slick and sexy new take on the cold war spy genre. What if the secretary to the man running the world\'s most top secret spy agency was actually their most dangerous weapon, once upon a time?', 'Ed Brubaker', '../upload/bookPfp/Velvet.png', 205),
(92, 'Vacancy', 30.00, 'Is a dystopian story about the sometimes opposing needs for safety and companionship. Lee\'s style is bold and the action leaps through the graphic frames. It speaks not just to the fears of survival but a deep fear of isolation.', 'Jen Lee', '../upload/bookPfp/Vacancy.png', 205),
(93, 'Guts', 68.50, 'Raina wakes up one night with a terribly upset stomach. Her mom has one, too, so it\'s probably just a bug. Raina eventually returns to school, where she\'s dealing with the usual highs and lows: friends, not-friends, and classmates who think the school year is just one long gross-out session.', 'Raina Telgemeier', '../upload/bookPfp/Guts.png', 205),
(94, 'Gyo', 69.99, 'In Gyo, a single fish crawls on to the Okinawa shore. . . but it has legs, weird, and then more and more, 400 pages of obsessive nightmare fish, sharks with legs, crawling up and killing people and smashing things.', 'Junji Ito', '../upload/bookPfp/Gyo.png', 205),
(95, 'Cabin Fever', 58.00, 'Greg Heffley is in big trouble. School property has been damaged, and Greg is the prime suspect. But the crazy thing is, he’s innocent. Or at least sort of. The authorities are closing in, but when a surprise blizzard hits, the Heffley family is trapped indoors.', 'Jeff Kinney', '../upload/bookPfp/Cabin Fever.png', 205),
(96, 'Super Mario Adventures', 99.99, 'Super Mario Adventures is an anthology of comics that ran in Nintendo Power throughout 1992, featuring the characters from Nintendo\'s Mario series and based loosely on Super Mario World.', 'Kentaro Takekuma', '../upload/bookPfp/Super Mario Adventures.png', 205),
(97, 'Percy Gloom', 26.99, 'The titular character is a little sad sack of a lazy-eyed guy who suffers mightily in a strange world where he is afflicted by everything from an Orwellian bureaucracy to an impossibly weak stomach.', 'Cathy Malkasian', '../upload/bookPfp/Percy Gloom.png', 205),
(98, 'Jane Austen: An Illustrated Biography', 39.99, 'Enchanting illustrations and handwritten text featuring excerpts from Austen\'s personal letters outline the intimate details of the literary icon\'s life—her childhood on a farm, the writing of her first novella, her marital woes, the inspiration behind Sense and Sensibility and Pride and Prejudice, and more.', 'Zena Alkayat', '../upload/bookPfp/Jane Austen - An Illustrated Biography.png', 205),
(99, 'Dogs Rule Nonchalantly', 45.50, 'is a collection of twenty years worth of whimsical dog paintings complemented by hand-written observations of dog behavior and first person experiences garnered over a lifetime of being a “dog person”…', 'Mark Ulriksen', '../upload/bookPfp/Dogs Rule Nonchalantly.png', 205),
(100, 'A Dog\'s Life', 80.00, 'This is a charming tale of life in Provence as seen through the eyes of Peter Mayle\'s dog, one of Provence\'s best-known former residents. It is a witty view of life from three-feet off the ground, with the dog sharing his ups and downs, positive and negative encounters, lovelife, and general world view!', 'Peter Mayle', '../upload/bookPfp/A Dog\'s Life.png', 205),
(101, 'The Very Hungry Caterpillar', 68.50, 'Is a story about a small caterpillar who emerges from an egg and begins eating everything in sight. After six days of eating fruits, sweets, and “junk” food, he gets a stomach ache. On the seventh day, the caterpillar eats a “nice leaf” and feels much better.', 'Eric Carle', '../upload/bookPfp/The Very Hungry Caterpillar.png', 301),
(102, 'Green Eggs and Ham', 40.99, 'Is about Sam-I-Am\'s attempt to convince the narrator to try green eggs and ham. He spends most of the book offering the unnamed narrator different locations and dining partners to try the delicacy. In the end, the narrator relents and eats the green eggs and ham and ends up loving the food.', 'Dr Seuss', '../upload/bookPfp/Green Eggs and Ham.png', 301),
(103, 'Goodnight Moon', 29.99, 'Tells the story of a rabbit getting ready for bed, bidding adieu to a series of items in his bedroom: a little toy house and a young mouse, “a comb and a brush and a bowl full of mush and a quiet old lady who was whispering \'hush.', 'Margaret Wise Brown', '../upload/bookPfp/Goodnight Moon.png', 301),
(104, 'The Giving Tree', 18.99, 'The story is about the life and friendship of an apple tree and a little boy, who develop a beautiful relationship with one another. The tree was very “giving” in nature, and eventually, the boy evolves into a “receiving” little kid, then a teenager, to a middle-aged man, and finally, an old man.', 'Shel Silverstein', '../upload/bookPfp/The Giving Tree.png', 301),
(105, 'The Lorax', 37.00, 'Long before saving the earth became a global concern, Dr. Seuss, speaking through his character the Lorax, warned against mindless progress and the danger it posed to the earth\'s natural beauty.', 'Dr Seuss', '../upload/bookPfp/The Lorax.png', 301),
...
(107, 'Corduroy', 30.99, 'This beloved book tells the story of Corduroy, a stuffed teddy bear, as he waits on a shelf for the love of a child. When a mother won\'t buy Corduroy for her little girl because he is missing a button from his overalls, the little bear goes on a nighttime adventure in the store to look for it.', 'Don Freeman', '../upload/bookPfp/Corduroy.png', 301),
(108, 'Chicka Chicka Boom Boom', 77.00, 'Is a vibrant and engaging book that\'s perfect for introducing young children to the alphabet. This beloved classic combines catchy rhymes with colorful, lively illustrations that bring the letters of the alphabet to life.', 'Bill Martin Jr', '../upload/bookPfp/Chicka Chicka Boom Boom.png', 301),
(109, 'Are You My Mother?', 89.99, 'Is a story about a hatchling bird. His mother, thinking her egg will stay in her nest where she left it, leaves her egg alone and flies off to find food. The baby bird hatches while the mother is away.', 'P.D.Eastman', '../upload/bookPfp/Are You My Mother.png', 301),
(110, 'Stellaluna', 45.00, 'It is about a young fruit bat, Stellaluna, who becomes separated from her mother and finds her way to a nest of birds. She is adopted by them and learns bird-like behavior.', 'Janell Cannon', '../upload/bookPfp/Stellaluna.png', 301),
(111, 'Peter Pan', 54.50, 'A free-spirited and mischievous young boy who can fly and never grows up, Peter Pan spends his never-ending childhood having adventures on the mythical island of Neverland as the leader of the Lost Boys, interacting with fairies, pirates, mermaids, Native Americans, and occasionally ordinary children from the world.', 'J.M.Barrie', '../upload/bookPfp/Peter Pan.png', 302),
(112, 'The Little Mermaid', 25.99, 'The Little Mermaid\" by Hans Christian Andersen was written in 1836. Anderson tells the story of a young sea princess who longs to become human. She has a deep desire to go above the shore even from an early age, but her desire becomes stronger when she falls in love with a handsome prince.', 'Hans Christian Andersen', '../upload/bookPfp/The Little Mermaid.png', 302),
(113, 'The Little Prince', 33.50, 'The story follows a young prince who visits various planets, including Earth, and addresses themes of loneliness, friendship, love, and loss. Despite its style as a children\'s book, The Little Prince makes observations about life, adults, and human nature.', 'Antoine de Saint-Exupery', '../upload/bookPfp/The Little Prince.png', 302),
(114, 'Cinderella and the Furry Slippers', 95.99, 'Cinderella is dying to go to the ball. She\'s seen pictures of the fancy castle and the handsome prince, she\'s heard the fairy tales about true love, she\'s found the perfect dress in Princess magazine and she\'s even found an ad for a Fairy Godmother. She\'s all set.', 'Davide Cali', '../upload/bookPfp/Cinderella and the Furry Slippers.png', 302),
(115, 'Goatilocks and the Three Bears', 30.00, 'Once upon a time, there was a kid named Goatilocks. She lived down the road from a family of bears... Goatilocks can\'t resist sampling first Papa Bear\'s porridge, then Mama Bear\'s porridge, then Baby Bear\'s porridge—and his bowl and spoon, too. And it turns out Goatilocks has a taste for chairs and beds as well.', 'Erica S.Perl', '../upload/bookPfp/Goatilocks and the Three Bears.png', 302),
(116, 'The Snow Queen', 82.00, 'It is one of Andersen\'s longest stories and is divided into seven chapters. It tells the story of a mirror fashioned by demons that is shattered. A piece of the glass enters the eye and the heart of a little boy named Kai. He is carried by the Snow Queen to her palace in the far north.', 'Hans Christian Andersen', '../upload/bookPfp/The Snow Queen.png', 302),
(117, 'The White Cat', 34.99, 'The White Cat is about a world changed by magic. The White Cat helps the youngest prince win his father\'s throne.', 'Errol Le Cain', '../upload/bookPfp/The White Cat.png', 302),
(118, 'The Reluctant Dragon', 52.00, 'In Grahame\'s story, a young boy discovers an erudite, poetry-loving dragon living in the Downs above his home. The two become friends, but soon afterwards the dragon is discovered by the townsfolk, who send for St George to rid them of him.', 'Kenneth Grahame', '../upload/bookPfp/The Reluctant Dragon.png', 302),
(119, 'Red Riding Hood', 14.99, 'So begins Beatrix Potter\'s retelling of Red Riding Hood. A darkly delicious adaptation of the classic tale, filled with trademark Potter wit and flourishes, little Red Riding Hood sets off to Granny\'s house with a very hungry wolf in tow. But nobody saw her pass.', 'Beatrix Potter', '../upload/bookPfp/Red Riding Hood.png', 302),
(120, 'The Frog in the Wall', 78.99, 'In The Frog in the Well, Tresselt and Duvoisin offer a sweet tale of a frog who beats his fears and explores the world. Once upon a time there was a frog who lived at the bottom of a well. The well was the frog\'s whole world, until the day the well ran dry and the bugs began to disappear.', 'Alvin Tresselt', '../upload/bookPfp/The Frog in the Wall.png', 302),
(121, 'Punctuation Takes a Vacation', 25.99, 'After a lesson goes awry on the hottest, stickiest day of the year, Punctuation decides to go on vacation. Maybe if the kids have to live without punctuation for a while, they\'ll appreciate all the hard work commas, apostrophes, exclamation points, and question marks do!', 'Robin Pulvel', '../upload/bookPfp/Punctuation Takes a Vacation.png', 303),
(122, 'The Grapes of Math', 55.99, 'The Grapes Of Math by Greg Tang is a book that encourages groupings of numbers in order to assist in quick addition. It shows a different way of looking at a group of objects - snails, grapes, fish etc.', 'Greg Tang', '../upload/bookPfp/The Grapes of Math.png', 303),
(123, 'Zero the Hero', 61.99, 'Zero. Zip. Zilch. Nada. That\'s what all the other numbers think of Zero. He doesn\'t add anything in addition. He\'s of no use in division. And don\'t even ask what he does in multiplication. ( Poof! ) But Zero knows he\'s worth a lot, and when the other numbers get into trouble, he swoops in to prove that his talents are innumerable.', 'Joan Holub', '../upload/bookPfp/Zero the Hero.png', 303),
(124, 'Math Curse', 46.99, 'Math Curse is a children\'s picture book written by Jon Scieszka and illustrated by Lane Smith. Published in 1995 through Viking Press, the book tells the story of a student who is cursed by the manner in which mathematics is connected to everyday life.', 'Jon Scieszka', '../upload/bookPfp/Math Curse.png', 303),
(125, 'How Much Is a Million?', 35.99, 'Knocks complex numbers down to size in a fun, humorous way, helping children conceptualize a difficult mathematical concept. It\'s a math class you\'ll never forget.', 'David M.Schwartz', '../upload/bookPfp/How Much Is a Million.png', 303),
(126, 'Dr.Seuss\'s ABC', 47.50, 'Seuss\'s ABC, otherwise referred to as The ABC, is a 1963 English language alphabet book written by Dr. Seuss starring two anthropomorphic yellow rabbits named Ichabod and Izzy as they journey through the alphabet and meet characters whose names begin with each letter.', 'Dr Suess', '../upload/bookPfp/Dr.Seuss\'s ABC.png', 303),
(127, 'The Stone Lions', 84.00, 'The Stone Lions is a story about a lifelike stone lion that sits outside the library day in and day out. Intertwined in a mystery of math, art and magic, Ara races to find the seven broken symmetries before time runs out.', 'Gwen Dandridge', '../upload/bookPfp/The Stone Lions.png', 303),
(128, 'Weather Or Not', 26.99, 'Weather is one of the most talked about subjects in the world. Here, Trafford invites kids, parents and teachers to join the conversation. Understanding climate change is critical but difficult. The complex issues surrounding climate change are simplified so that all readers can understand the very real threat to our planet.', 'Caren Trafford', '../upload/bookPfp/Weather Or Not.png', 303),
(129, 'The Last Honey Bee', 28.50, 'Manderlee is a very sad honey bee. Humans destroyed the thriving bee colony she lived in with fire and poison. The queen bee, drones, and worker bees perished, but Manderlee survived. She had to travel far to seek a new colony and was almost made into honey bee cake by Kala Kaghee, an angry seagull.', 'Wayne Gerard Trotman', '../upload/bookPfp/The Last Honey Bee.png', 303),
(130, 'Eat Your Math Homework', 35.00, 'This collection of yummy recipes and fun math facts is sure to tempt taste buds and make you hungry for more. Explore patterns in nature while you chomp on Fibonacci Stack Sticks. Amaze your friends with delicious Variable Pizza Pi! Wash down your geometry assignment with some Milk and Tangram Cookies.', 'Ann McCallum Staats', '../upload/bookPfp/Eat Your Math HomeWork.png', 303),
